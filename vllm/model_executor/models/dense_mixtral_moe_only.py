...
class DenseMixtralMoEOnlyDecoderLayer(nn.Module):
    """
...
class DenseMixtralMoEOnlyModel(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: DenseMixtralMoEOnlyDecoderLayer(
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        raise NotImplementedError("Loading weights is not supported for DenseMixtralMoEOnlyModel")


class DenseMixtralMoEOnlyForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = DenseMixtralMoEOnlyModel(vllm_config=vllm_config, prefix=maybe_prefix(prefix, "model"))
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        raise NotImplementedError("Loading weights is not supported for DenseMixtralMoEOnlyForCausalLM")
